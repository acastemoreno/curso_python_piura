...
** Virtualenv
=Virtualenv= es una herramienta usada para crear un ambiente Python aislado. Este ambiente tiene su propio directorio de instalación que no comparte librerías con otros ambientes virtualenv (y opcionalmente tampoco accede las librerías globales instaladas).
...
#estando ubicados en la carpta creada por el comando *virtualenv env --python=python3*
$ source bin/activate
(env)$
...
[fn:5] [[https://virtualenv.pypa.io/en/latest/][Documentacion Virtualenv]]